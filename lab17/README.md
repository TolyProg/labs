...
- Макс. сложность: выполните задание с использованием NoSQL СУБД + ORM/ODM (MongoDB + Beanie, ArangoDB + Pydango, и т.д.)
...
Pапросы для выборки и анализа данных из БД (как указанно в задании):
